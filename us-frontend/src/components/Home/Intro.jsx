...
const Intro = () => {
  ...
  return (
    <div className="intro-wrapper pt-[17%] pb-[15%] bg-black ">
      <motion.div
        className="upper-part lg:max-w-[70%] xl:max-w-[75%] lg:mt-28 xl:mt-0 mx-auto"
        ref={ref}
        variants={{
      ...
      >
        ...
        <div
          className="description-about-application text-white text-center xl:px-10 text-md lg:mt-[3%] xl:mt-[2.2%]"
